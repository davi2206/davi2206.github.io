...
You will need a lot of training though, before getting any work, but you are always on the right side of the law. 
...
Black Hat Hackers are the criminals of the internet. They work for their own gains, either financial or political, and will use any tools necessary to get the job done. They will go after business or governments, to steal money or information, and they don't care that it is illegal. Don't be in the category. If you are, we can no longer be friends. 

## Getting started
If you have absolutely no clue where to start, I would suggest looking into tutorials on setting up a home-lab for secure testing. Then start looking into Capture The Flag (CTF) challenges around the internet. There are plenty of them, and they are often free to join. The idea of a CTF is to hack a system to find "flags". The flags are usually some text, or other token, to prove you made the goal. CTF challenges are usually hosted on closed systems, where you only have access to the infrastructure that you need to complete the task. They are often completely separated from the rest of the world, to prevent accidentally breaking something outside the game. 
