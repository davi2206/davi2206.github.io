...
**Specific**: It should be clear what the goal is, and when it is completed. "Get in shape" is too fluffy. What does it even mean to 'be in shape'. "Train to be able to do 50 pushups in a set, and run a 5K under 30 min" is much more clear, and there is something concrete to work towards. <br>
