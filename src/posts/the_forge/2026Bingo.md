...
One thing I found works, somewhat consistently, is gamifying the process. I recently saw someone make a "Bingo card" with their goals for the year, and I thought that might actually be a good idea. It both allows for a clear collection of goals, and makes an easy way to track the overall progress. 
...
## Keeping track
Obviously, some of these goals are not completed all at once (Ex. read 12 books). To keep track of those, I have created another tracker, to  see the progress towards the goals, where that makes sense. <br>
...
Start by making a list of things you want to experience and milestones you want to reach. The more you have, the more options you have, for curating a list of what actually matters. Some of the goals you write down, might turn out to be things you feel others would see as good milestone, but that you don't actually care about yourself. Delete those goals. The goals you set should be for you, adn you only. Not for anyone else, or for fame or recognition. <br>
...
If you want a bingo card, there are generators online that can help with that, or you can use a spreadsheet or text editor. <br>
...
A short explanation, to try and clarify what these all mean: <br>
